  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-accent/20 to-background overflow-hidden">
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <Button
              size="lg"
              className="bg-primary hover:bg-primary/90 px-8 py-3 hover:scale-105 transition-transform duration-200"
            >
      ...
      <motion.section
        ...
        className="px-6 py-20 bg-accent/10"
      >
            ...
            <motion.div variants={fadeInUp}>
              <Card className="group hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>
                    Разработка и производство современной мебели для дома и
                    офиса
                  </CardDescription>
                </CardHeader>
                <CardContent>
      ...
      <motion.section
        id="portfolio"
        initial="hidden"
        animate={isVisible.portfolio ? "visible" : "hidden"}
        variants={staggerContainer}
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div variants={fadeInUp}>
              <div className="group relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:scale-105">
                <img
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={fadeInRight}>
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-6 bg-background rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                  <Icon
                    name="Lightbulb"
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <motion.div variants={fadeInRight}>
              <div className="bg-accent/10 rounded-lg p-8 hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full p-3 border border-border rounded-md focus:ring-2 focus:ring-primary/20 transition-all duration-200"
                    />
                  </div>
                  <div>
                    <label className="text-sm font-medium mb-1 block">
